...
export const API_GET_QR_CODE = 'admin/qr-code/SBPS';
export const API_EXPORT_QR_CODE = 'admin/qr-code/export/SBPS'
export const API_NEW_QR = '/admin/qr-code/SBPS';
export const API_GET_REQUEST = '/admin/qr-code/files/SBPS'
export const API_GET_REQUEST_BY_ID = '/admin/qr-code/files'
export const API_POST_APPROVED = '/admin/qr-code/approve/SBPS'
export const API_POST_REJECT = '/admin/qr-code/reject/SBPS'
